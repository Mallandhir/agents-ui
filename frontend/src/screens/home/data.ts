export const categories = [
  { id: 1, name: "SALES & OUTREACH", isActive: true },
  { id: 2, name: "MARKET RESEARCH", isActive: false },
...
export const taskSuggestions = [
  { id: 1, text: "Find & qualify high-potential leads", isActive: false },
  { id: 2, text: "Automate LinkedIn outreach", isActive: false },
