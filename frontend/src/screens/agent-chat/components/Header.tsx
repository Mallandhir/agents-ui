      ...
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <div
              className={`relative w-6 h-6 bg-[url(${avatarUrl})] bg-cover bg-center`}
            >
            ...
            <div className="flex flex-col items-start justify-center gap-1.5">
              <div className="font-medium text-[#292929] text-base">
                {title}
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center gap-3">
          <div className="text-[#3c3c3c] text-sm tracking-tight">
            {progress}%
          </div>
          ...
          <div className="relative w-4 h-4">
            <div className="relative w-5 h-5 -top-0.5 -left-px">
              ...
              <Progress
                className="absolute w-5 h-5 top-0 left-px"
                value={progress}
              />
            </div>
          </div>
